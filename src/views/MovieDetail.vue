...
export default {
  ...
  beforeCreate() {
    const recommendationList = () => {
      fetch(
        `https://api.themoviedb.org/3/movie/${this.id}/recommendations?api_key=${YOUTUBE_API}`
      )
    ...
    const castList = () => {
      fetch(
        `https://api.themoviedb.org/3/movie/${this.id}/credits?api_key=${YOUTUBE_API}`
      )
        .then((response) => response.json())
        .then((data) => {
    ...
    const reviewList = () => {
      fetch(
        `https://api.themoviedb.org/3/movie/${this.id}/reviews?api_key=${YOUTUBE_API}`
      )
        .then((response) => response.json())
        .then((data) => {
